...
export default function BarChartComponent({ attendanceList, totalPresentData, selectedMonth }) {
    ...
    const formatAttendanceListCount = () => {
        ...
        const result = daysInMonth.map((day) => {
            const presentData = totalPresentData.find((item) => item.day == day) || { presentCount: 0 };
            return {
                day: day,
                ...
                <div>
                    ...
                    <ResponsiveContainer width="100%" height={400}>
                        ...
                        >
                            ...
                            <Tooltip />
                            <Legend />
                            <Bar dataKey="presentCount" name="Total Kehadiran" fill="#8884d8" />
